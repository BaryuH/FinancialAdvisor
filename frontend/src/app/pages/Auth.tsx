...
import { ShieldCheck, ArrowLeft, Mail, Lock, UserRound, CheckCircle2 } from "lucide-react";
...
const COPY = {
  en: {
    ...
    subtitle: "Sign in to sync your portfolio, budgets, and smart insights.",
    signin: "Sign in",
    signup: "Sign up",
    signinTitle: "Continue your finance journey",
    signinHint: "Use your email and password to access your workspace.",
    signupTitle: "Create your account",
    signupHint: "Get a personalized dashboard in under one minute.",
    fullName: "Full name",
    email: "Email",
    password: "Password",
    ...
    authSuccess: "Auth flow ready. Backend auth will be connected next.",
    trust1: "Encrypted account sessions",
    trust2: "Your financial data stays private",
  },
  vi: {
    ...
    authSuccess: "Giao diện auth đã sẵn sàng. Bước tiếp theo là nối backend auth.",
...
export function Auth() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    toast.success(text.authSuccess);
                  ...
                  <form className="mt-5 space-y-4" onSubmit={handleSubmit}>
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        ...
                        <Input id="signin-email" type="email" required placeholder="name@email.com" className="h-11 pl-9" />
                      </div>
                    </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        ...
                        <Input id="signin-password" type="password" required placeholder="••••••••" className="h-11 pl-9" />
                      </div>
                    </div>
                  ...
                  <form className="mt-5 space-y-4" onSubmit={handleSubmit}>
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        ...
                        <Input id="signup-name" type="text" required placeholder="Nguyen Van A" className="h-11 pl-9" />
                      </div>
                    </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        <Mail className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground" />
                        <Input id="signup-email" type="email" required placeholder="name@email.com" className="h-11 pl-9" />
                      </div>
                    </div>
